...
public class DeclarationFactoryImpl extends EFactoryImpl implements DeclarationFactory {
	...
	public static DeclarationFactoryImpl init() {
		try {
			DeclarationFactoryImpl theDeclarationFactory = (DeclarationFactoryImpl)EPackage.Registry.INSTANCE.getEFactory("http:///dk/au/daimi/ascoveco/cpn/model/declaration.ecore"); 

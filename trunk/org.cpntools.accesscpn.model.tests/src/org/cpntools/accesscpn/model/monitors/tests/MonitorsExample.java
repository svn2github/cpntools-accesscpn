...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>monitors</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitorsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(MonitorsPackageImpl.eNS_URI, 
			 MonitorsPackageImpl.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.monitors"));
				Monitor root = MonitorsFactoryImpl.eINSTANCE.createMonitor();

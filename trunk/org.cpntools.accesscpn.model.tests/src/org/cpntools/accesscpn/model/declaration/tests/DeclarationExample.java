...
import org.cpntools.accesscpn.model.declaration.DeclarationPackage;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>declaration</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DeclarationExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.declaration"));
				VariableDeclaration root = DeclarationFactory.eINSTANCE.createVariableDeclaration();
